    ...
    <section className="py-12 sm:py-16 lg:py-20 bg-gradient-to-br from-distill-purple/10 via-dark-slate to-dark-slate">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
          <a href="https://github.com/smeltery/distill" target="_blank" rel="noopener noreferrer" className="bg-dark-gray/50 border border-distill-purple/30 hover:border-distill-purple rounded-xl p-6 sm:p-8 transition-all group hover:shadow-lg hover:shadow-distill-purple/20">
          ...
          <a href="https://github.com/smeltery/distill#readme" target="_blank" rel="noopener noreferrer" className="bg-dark-gray/50 border border-distill-violet/30 hover:border-distill-violet rounded-xl p-6 sm:p-8 transition-all group hover:shadow-lg hover:shadow-distill-violet/20">
          ...
          <a href="https://github.com/smeltery/distill/discussions" target="_blank" rel="noopener noreferrer" className="bg-dark-gray/50 border border-distill-lavender/30 hover:border-distill-lavender rounded-xl p-6 sm:p-8 transition-all group hover:shadow-lg hover:shadow-distill-lavender/20">
